...
export default function Contato() {
  ...
  const handleSubmit = (e) => {
    ...
    const numeroWhatsApp = "556239323670"; // Exemplo: +55 para Brasil, 62 para Goiás
  ...
  const endereco = "MEDK DO BRASIL LTDA";
  const urlMaps = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(endereco)}`;

  const telefone = "(62)3086-3776";
  const urlTel = "tel:+556230863776";
