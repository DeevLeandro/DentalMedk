    ...
    <footer>
      <div className="pager-inner-content">
        ...
        <div>
          ...
          <h1 className="logo1">
           <span>MEDK DO BRASIL</span>
            </h1>
            <p>
            Agradecemos pela confiança em nossa distribuidora, a MEDK Do Brazil - Materiais Odontológicos.
            ...
            <p className="copyright">
             Copyright 2030 - MEDK DO BRASIL - Todos Direitos Reservados 
            </p>
        </div>
      </div>
    </footer>
